...
#===================================================================================
#
# FILE: webrtcbee-publisher-sm.sh
#
# USAGE: webrtcbee-publisher-sm.sh [basic-publisher.html_endpoint_with_params] [SM_username] [SM_password] [Nodegroup_name] [stream_name] [amount_of_streams_to_start] [amount_of_time_to_playback_in_seconds] [path_to_the_video_file.y4m] [path_to_the_audio_file.wav]
#
# EXAMPLE FOR VIDEO+AUDIO:  ./webrtcbee-publisher-sm.sh "https://your.red5pro-deploy.com/red5/proxy-publisher.html?cameraWidth=1280&cameraHeight=720&fr=30&bwV=1500&bwA=56&video=1&audio=1&protocol=wss&port=443&whipwhep=true&verbose=1" example_user example_pass your_nodegroup stream1 10 60 /path_to_the_video_file/test.y4m /path_to_the_audio_file/test.wav
# EXAMPLE FOR AUDIO ONLY:  ./webrtcbee-publisher-sm.sh "https://your.red5pro-deploy.com/red5/proxy-publisher.html?cameraWidth=1280&cameraHeight=720&fr=30&bwV=1500&bwA=56&video=0&audio=1&protocol=wss&port=443&whipwhep=true&verbose=1" example_user example_pass your_nodegroup stream1 10 60 null /path_to_the_audio_file/test.wav
#
...
# ./webrtcbee-publisher-sm.sh "https://your.red5pro-deploy.com/red5/proxy-publisher.html?cameraWidth=1280&cameraHeight=720&fr=30&bwV=1500&bwA=56&video=1&audio=1&protocol=wss&port=443&whipwhep=true&verbose=1" example_user example_pass your_nodegroup stream1 1 60 /home/ubuntu/video_examples/240p.y4m /home/ubuntu/video_examples/test_high.wav

# Publish WebRTC stream with audio only
# ./webrtcbee-publisher-sm.sh "https://your.red5pro-deploy.com/red5/proxy-publisher.html?cameraWidth=1280&cameraHeight=720&fr=30&bwV=1500&bwA=56&video=0&audio=1&protocol=wss&port=443&whipwhep=true&verbose=1" example_user example_pass your_nodegroup stream1 1 60  null /home/ubuntu/video_examples/test_high.wav
...
mkdir -p "${current_dir}"
log_file="${current_dir}/webrt_sm_pub"
...
if [[ -z "$endpoint" || -z "$stream_name" || -z "$amount" || -z "$timeout" || -z "$video_file" || -z "$audio_file" ]]; then
    ...
    log_w "USAGE: ./webrtcbee-publisher-sm.sh [basic-publisher.html_endpoint_with_params] [SM_username] [SM_password] [Nodegroup_name] [stream_name] [amount_of_streams_to_start] [amount_of_time_to_playback_in_seconds] [path_to_the_video_file.y4m] [path_to_the_audio_file.wav]"
    log_w "Example: ./webrtcbee-publisher-sm.sh 'https://your.red5pro-deploy.com/red5/proxy-publisher.html?cameraWidth=1280&cameraHeight=720&fr=30&bwV=1500&bwA=56&video=1&audio=1&protocol=wss&port=443&whipwhep=true&verbose=1' example_user example_pass your_nodegroup stream1 1 60 /home/ubuntu/video_examples/240p.y4m /home/ubuntu/video_examples/test_high.wav"
    exit 1
fi
...
for ((i=1;i<=amount;i++)); do
    ...
    endpoint_with_params="${endpoint}&streamName=${name}&nodeGroup=${nodegroup_name}&smuser=${sm_username}&smpass=${sm_password}"
